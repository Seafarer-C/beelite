...
function distBBox(node, k, p2, toBBox2, destNode) {
...
class BlockSpatialIndex {
  ...
  searchWorldRect(minX, minY, maxX, maxY) {
    return this.tree.search({ minX, minY, maxX, maxY }).map((b) => b.id);
  }
}
function worldRectFromViewport(viewport, viewportSize, overscanPx) {
...
function filterSegmentsForNodes(segments, edges, relevantNodeIds) {
...
const knowledgeUniverseHero = "" + new URL("knowledge-universe-hero-C1OVjYAb.png", import.meta.url).href;
...
const mockBlocks = [
  ...
  },
  {
    ...
    content: {
      ...
      heroImage: "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=600&q=80&auto=format&fit=crop"
    },
  ...
  },
  {
    ...
    content: {
      ...
      body: "人们很早就学会用图像补充语言：地图、图表与示意图降低了协作成本。数字画布把这一过程推向极致——任意叠放、缩放与批注，让思考不必先收敛成线性大纲。\n\n在知识工作中，重要的往往不是「放在哪个文件夹」，而是「它和谁相邻」。空间记忆提供了第二条检索路径。",
  ...
  },
  {
    ...
    content: {
      ...
      body: "标签与目录擅长分类，却不擅长表达「此刻的相关性」。画布上的邻近关系是一种弱链接：它可随项目演进重排，而不破坏文档本身。\n\n把摘录、网页剪藏与长文草稿放在同一视域里，你会更容易发现缺口与重复。",
      highlights: ["弱链接", "网页剪藏"]
    },
...
const mockProposal = createGraphProposal({
  id: "proposal-rag-001",
  title: "RAG 知识结构初稿",
...
const useWorkspaceStore = /* @__PURE__ */ defineStore("workspace", () => {
  ...
  const selectedBlockId = /* @__PURE__ */ ref("block-hero-art");
  const viewport = /* @__PURE__ */ ref({ x: 600, y: 420, zoom: 0.5 });
  ...
  const previewBlockId = /* @__PURE__ */ ref(null);
  ...
  function moveBlockBy(blockId, deltaWorldX, deltaWorldY) {
    const i = blocks.value.findIndex((b2) => b2.id === blockId);
    if (i === -1) return;
  ...
  function updateBlockBody(blockId, body) {
    const i = blocks.value.findIndex((b2) => b2.id === blockId);
    if (i === -1) return;
    const b = blocks.value[i];
    blocks.value[i] = {
  ...
  function setPreviewBlock(blockId) {
...
const _hoisted_6$5 = { class: "zoom-controls" };
const _hoisted_7$5 = {
  class: "help-button",
  type: "button",
  "aria-label": "帮助"
        ...
        createBaseVNode("nav", _hoisted_3$7, [
          (openBlock(), createElementBlock(Fragment, null, renderList(navItems, (item) => {
            return createBaseVNode("button", {
              key: item.label,
              class: normalizeClass(["nav-item", { active: item.active }]),
              type: "button"
            }, [
        ...
        createBaseVNode("section", _hoisted_5$5, [
          createBaseVNode("div", _hoisted_6$5, [
            createBaseVNode("button", {
              type: "button",
              "aria-label": "缩小",
              onClick: _cache[0] || (_cache[0] = ($event) => unref(store).zoomBy(-0.06))
            }, [
              createVNode(unref(Minus), { size: 15 })
            ]),
            createBaseVNode("strong", null, toDisplayString(zoomLabel.value), 1),
            createBaseVNode("button", {
              type: "button",
              "aria-label": "放大",
              onClick: _cache[1] || (_cache[1] = ($event) => unref(store).zoomBy(0.06))
            }, [
              createVNode(unref(Plus), { size: 15 })
            ])
          ]),
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$7, [
        (openBlock(), createElementBlock(Fragment, null, renderList(tools, (tool) => {
          return createBaseVNode("button", {
            key: tool.id,
            class: normalizeClass(["tool-button", { active: unref(store).activeTool === tool.id }]),
            type: "button",
            title: tool.label,
...
const _hoisted_2$6 = { class: "block-preview-topbar" };
const _hoisted_3$6 = { class: "block-preview-title" };
const _hoisted_4$5 = { class: "block-preview-actions" };
const _hoisted_5$4 = {
  key: 0,
  class: "block-preview-body block-preview-body--media"
};
const _hoisted_6$4 = {
  key: 0,
  class: "block-preview-stamp-full"
};
const _hoisted_7$4 = ["src"];
const _hoisted_8$4 = {
  key: 0,
  class: "block-preview-caption"
};
const _hoisted_9$4 = {
  key: 1,
  class: "block-preview-body block-preview-body--media"
...
const _hoisted_11$4 = {
  key: 1,
  class: "block-preview-empty"
};
const _hoisted_12$3 = {
  key: 2,
  class: "block-preview-body block-preview-body--markdown"
};
const _hoisted_13$3 = ["innerHTML"];
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  __name: "BlockPreviewOverlay",
  setup(__props) {
    const store = useWorkspaceStore();
    const block = computed(
      () => store.previewBlockId ? store.blocks.find((b) => b.id === store.previewBlockId) ?? null : null
    );
    const mdEditing = /* @__PURE__ */ ref(false);
    const draftBody = /* @__PURE__ */ ref("");
    ...
    const highlights = computed(() => {
      const h2 = block.value?.content.highlights;
      return Array.isArray(h2) ? h2.map(String) : [];
    });
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(Teleport, { to: "body" }, [
        block.value ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: "block-preview-root",
          role: "dialog",
          "aria-modal": "true",
          "aria-label": title.value || "预览"
        }, [
          createBaseVNode("div", {
            class: "block-preview-backdrop",
            onClick: close
          }),
          createBaseVNode("div", {
            class: normalizeClass(["block-preview-panel", { "block-preview-panel--markdown": block.value.type === "markdown" }]),
            onClick: _cache[1] || (_cache[1] = withModifiers(() => {
            }, ["stop"]))
          }, [
            createBaseVNode("header", _hoisted_2$6, [
              createBaseVNode("h1", _hoisted_3$6, toDisplayString(title.value || "预览"), 1),
              createBaseVNode("div", _hoisted_4$5, [
                block.value.type === "markdown" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                  !mdEditing.value ? (openBlock(), createElementBlock("button", {
                    key: 0,
                    type: "button",
                    ...
                    _cache[2] || (_cache[2] = createTextVNode(" 编辑 ", -1))
                ...
                createBaseVNode("button", {
                  ...
                  createVNode(unref(X), { size: 22 })
                ])
              ])
            ]),
            block.value.type === "image" ? (openBlock(), createElementBlock("div", _hoisted_5$4, [
              isStamp.value && !imageSrc.value ? (openBlock(), createElementBlock("div", _hoisted_6$4, [
                _cache[3] || (_cache[3] = createBaseVNode("div", { class: "block-preview-stamp-fill" }, null, -1)),
                createVNode(unref(Clock), {
                  size: 72,
                  class: "block-preview-stamp-icon",
                  "stroke-width": "1.5"
                })
                ...
                caption.value ? (openBlock(), createElementBlock("p", _hoisted_8$4, toDisplayString(caption.value), 1)) : createCommentVNode("", true)
              ], 64))
            ])) : block.value.type === "video" ? (openBlock(), createElementBlock("div", _hoisted_9$4, [
              videoUrl.value ? (openBlock(), createElementBlock("video", {
                ...
                preload: "metadata",
                src: videoUrl.value
              }, null, 8, _hoisted_10$4)) : (openBlock(), createElementBlock("p", _hoisted_11$4, "未配置视频地址"))
            ])) : block.value.type === "markdown" ? (openBlock(), createElementBlock("div", _hoisted_12$3, [
              !mdEditing.value ? (openBlock(), createElementBlock("div", {
                key: 0,
                class: "block-preview-md-read",
                innerHTML: bodyHtml.value
              }, null, 8, _hoisted_13$3)) : withDirectives((openBlock(), createElementBlock("textarea", {
                key: 1,
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => draftBody.value = $event),
                class: "block-preview-md-editor",
                spellcheck: "true",
                rows: "1"
              }, null, 512)), [
                [vModelText, draftBody.value]
              ])
...
const _hoisted_3$5 = ["cx", "cy", "r"];
const _hoisted_4$4 = ["cx", "cy", "r"];
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  __name: "CanvasGraphOverlay",
  props: {
    segments: {},
    viewport: {}
  },
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("svg", _hoisted_1$5, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(lines.value, (line) => {
...
const _hoisted_2$4 = { class: "task-list" };
const _hoisted_3$4 = {
  key: 0,
  class: "image-stamp"
};
...
const _hoisted_9$3 = {
  key: 1,
  class: "video-card-placeholder"
};
const _hoisted_10$3 = { class: "video-card-scrim" };
const _hoisted_11$3 = { class: "video-card-title" };
const _hoisted_12$2 = { class: "card-header" };
const _hoisted_13$2 = { class: "flow-steps" };
const _hoisted_14$2 = {
  key: 4,
  class: "folder-card-inner"
};
const _hoisted_15$2 = { class: "folder-meta" };
const _hoisted_16$2 = { class: "folder-count" };
const _hoisted_17$2 = {
  key: 5,
  class: "media-header-card"
};
const _hoisted_18$2 = { class: "media-header-photo" };
const _hoisted_19$2 = ["src"];
const _hoisted_20$2 = { class: "media-header-body" };
const _hoisted_21$2 = { class: "card-header card-header--dense" };
const _hoisted_22$1 = {
  key: 0,
  class: "card-date"
};
const _hoisted_23$1 = { class: "markdown-body markdown-body--card-teaser" };
const _hoisted_24$1 = ["innerHTML"];
const _hoisted_25$1 = { class: "card-header" };
const _hoisted_26$1 = {
  key: 0,
  class: "tag-row"
};
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const highlights = computed(() => {
      const h2 = props.block.content.highlights;
      return Array.isArray(h2) ? h2.map(String) : [];
    });
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("article", {
        class: normalizeClass(["knowledge-card", [
          `type-${__props.block.type}`,
          {
            selected: isSelected.value,
            "is-folder": isFolder.value,
            "is-stamp": isStamp.value,
            "is-hero": isHero.value,
            "is-media-header": mediaLayout.value && __props.block.type === "knowledge"
          }
        ]])
      }, [
        __props.block.type === "task" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(taskItems.value, (item, index) => {
              return openBlock(), createElementBlock("li", { key: item }, [
                createBaseVNode("span", {
                  class: normalizeClass(["task-check", { done: checkedTasks.value[index] }])
                }, [
                  checkedTasks.value[index] ? (openBlock(), createBlock(unref(Check), {
                    key: 0,
                    size: 12
                  })) : createCommentVNode("", true)
                ], 2),
                createBaseVNode("span", null, toDisplayString(item), 1),
                index === 2 ? (openBlock(), createBlock(unref(Star), {
                  key: 0,
                  size: 14,
                  class: "task-star"
                })) : createCommentVNode("", true)
        ...
        ], 64)) : __props.block.type === "image" ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
          isStamp.value ? (openBlock(), createElementBlock("div", _hoisted_3$4, [
            _cache[0] || (_cache[0] = createBaseVNode("div", { class: "image-stamp-fill" }, null, -1)),
            createVNode(unref(Clock), {
              size: 44,
              class: "image-stamp-icon",
              "stroke-width": "1.75"
            })
            ...
            __props.block.content.caption ? (openBlock(), createElementBlock("p", _hoisted_6$3, toDisplayString(__props.block.content.caption), 1)) : createCommentVNode("", true)
          ]))
        ], 64)) : __props.block.type === "video" ? (openBlock(), createElementBlock("div", _hoisted_7$3, [
          videoUrl.value ? (openBlock(), createElementBlock("video", {
            key: 0,
          ...
          createBaseVNode("div", _hoisted_10$3, [
            createBaseVNode("span", _hoisted_11$3, toDisplayString(title.value || "Video"), 1),
            _cache[1] || (_cache[1] = createBaseVNode("span", { class: "video-card-hint" }, "点击全屏预览", -1))
          ])
        ])) : __props.block.type === "graph" ? (openBlock(), createElementBlock(Fragment, { key: 3 }, [
          createBaseVNode("header", _hoisted_12$2, [
            createBaseVNode("h2", null, toDisplayString(title.value), 1),
          ...
          createBaseVNode("div", _hoisted_13$2, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(steps.value, (step, index) => {
              return openBlock(), createElementBlock("span", { key: step }, [
                ...
                createBaseVNode("small", null, toDisplayString(step), 1)
              ]);
            }), 128))
          ]),
          _cache[2] || (_cache[2] = createBaseVNode("p", { class: "graph-caption" }, "antv 图表", -1))
        ], 64)) : __props.block.type === "knowledge" && isFolder.value ? (openBlock(), createElementBlock("div", _hoisted_14$2, [
          ...
          createBaseVNode("div", _hoisted_15$2, [
            createBaseVNode("span", _hoisted_16$2, toDisplayString(folderCount.value) + " items", 1),
            createBaseVNode("h2", null, toDisplayString(title.value), 1),
            createBaseVNode("p", null, toDisplayString(summary.value), 1)
          ])
        ])) : __props.block.type === "knowledge" && mediaLayout.value ? (openBlock(), createElementBlock("div", _hoisted_17$2, [
        ...
        ])) : __props.block.type === "markdown" ? (openBlock(), createElementBlock(Fragment, { key: 6 }, [
          createBaseVNode("header", _hoisted_21$2, [
            createBaseVNode("h2", null, toDisplayString(title.value), 1),
            dateLabel.value ? (openBlock(), createElementBlock("span", _hoisted_22$1, toDisplayString(dateLabel.value), 1)) : createCommentVNode("", true)
          ]),
          createBaseVNode("div", _hoisted_23$1, [
            createBaseVNode("div", {
              innerHTML: bodyWithHighlights()
            }, null, 8, _hoisted_24$1)
          ]),
          _cache[3] || (_cache[3] = createBaseVNode("p", { class: "markdown-card-hint" }, "点击全屏阅读", -1))
        ], 64)) : (openBlock(), createElementBlock(Fragment, { key: 7 }, [
          createBaseVNode("header", _hoisted_25$1, [
            createBaseVNode("h2", null, toDisplayString(title.value), 1),
          ...
          createBaseVNode("p", null, toDisplayString(summary.value), 1),
          tags.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_26$1, [
          ...
          createBaseVNode("footer", _hoisted_27$1, [
            ...
            createBaseVNode("span", {
              ...
              createVNode(unref(Circle), { size: 8 }),
              createTextVNode(" " + toDisplayString(Math.round(confidence.value * 100)) + "% ", 1)
            ], 2)
          ])
        ], 64))
      ], 2);
...
const _hoisted_1$3 = { class: "canvas-layer-stack" };
const _hoisted_2$3 = ["onPointerdownCapture"];
const _hoisted_3$3 = {
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const visibleIdSet = computed(() => {
      ...
      const h2 = height.value || 800;
      const idx = new BlockSpatialIndex();
      idx.load(store.blocks);
      const ids = visibleBlockIds(idx, store.viewport, { width: w, height: h2 }, 240);
      return new Set(ids);
    });
    ...
    const dragState = /* @__PURE__ */ reactive({
      active: false,
      pointerId: 0,
      lastX: 0,
      lastY: 0
    });
    const cardGesture = /* @__PURE__ */ reactive({
      blockId: null,
      pointerId: 0,
      startX: 0,
      startY: 0,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("section", {
        ...
        _cache[1] || (_cache[1] = createBaseVNode("div", { class: "canvas-texture" }, null, -1)),
        createBaseVNode("div", _hoisted_1$3, [
          createVNode(_sfc_main$5, {
            class: "canvas-graph-overlay-wrap",
            segments: overlaySegments.value,
            viewport: unref(store).viewport
          }, null, 8, ["segments", "viewport"]),
          createBaseVNode("div", {
            class: "canvas-surface",
            style: normalizeStyle(surfaceStyle.value)
          }, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(visibleBlocks.value, (block) => {
              return openBlock(), createElementBlock("div", {
                key: block.id,
                class: "block-frame",
                style: normalizeStyle(blockStyle(block)),
                onPointerdownCapture: ($event) => onBlockPointerDown($event, block)
              }, [
                createVNode(_sfc_main$4, { block }, null, 8, ["block"])
              ], 44, _hoisted_2$3);
            }), 128))
          ], 4)
        ]),
        createBaseVNode("div", _hoisted_3$3, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(store).blocks, (block) => {
            return openBlock(), createElementBlock("span", {
              key: block.id,
              class: "minimap-node",
              style: normalizeStyle(miniStyle(block))
            }, null, 4);
          }), 128)),
          _cache[0] || (_cache[0] = createBaseVNode("span", { class: "minimap-window" }, null, -1))
        ])
      ], 544);
    };
  }
